...
# mob_clock add
scoreboard players add @s[scores={mob_clock=..199}] mob_clock 1

# ability
execute as @s[scores={mob_clock=120..}] at @s if entity @e[type=#append_mobs:friendly,distance=..8] run function append_mobs:mobs/spider_swarm/summon
